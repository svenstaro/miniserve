    ...
    for entry in entries {
        ...
        match entry.entry_type {
            EntryType::Directory => {
                let _ = write!(
                    body,
                    "<tr><td><a class=\"directory\" href=\"{}\">{}/</a><span class=\"mobile-info\"><strong>Last modification:</strong> {} {}</span></td><td></td><td class=\"date-cell\"><span>{}</span><span>{}</span><span>{}</span></td></tr>",
                    entry.link, entry.name, modification_date, modification_time, modification_date, modification_time, humanize_duration(entry.last_modification_date)
                );
            }
            EntryType::File => {
                let _ = write!(
                    body,
                    "<tr><td><a class=\"file\" href=\"{}\">{}</a><span class=\"mobile-info\"><strong>Size:</strong> {}</span><span class=\"mobile-info\"><strong>Last modification:</strong> {} {}</span></td><td>{}</td><td class=\"date-cell\"><span>{}</span><span>{}</span><span>{}</span></td></tr>",
                    entry.link,
                    entry.name,
                    entry.size.unwrap(),
                    modification_date,
